...
require("lazy").setup({
	...
	--  The configuration is done below. Search for lspconfig to find it below.
	{
		...
		dependencies = {
			...
			-- Lua LSP configuration for Neovim APIs
			"folke/lazydev.nvim",
		},
		config = function()
...
vim.keymap.set("n", "<leader>dh", function() vim.diagnostic.enable(false) end, { desc = "Hide diagnostics" })
vim.keymap.set("n", "<leader>ds", function() vim.diagnostic.enable(true) end, { desc = "Show diagnostics" })
